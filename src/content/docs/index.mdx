...
<CardGrid stagger>
  ...
  <LinkCard title="Video introduction" description="Watch the introduction video to understand why" icon="youtube" href="https://www.youtube.com/watch?v=Z5Bz0DYga1k">
  </LinkCard>

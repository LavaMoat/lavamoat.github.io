...
For troubleshooting interactions with SES->lockdown you should be aware that LavaMoat is passing the following configuration to lockdown:
...
If you get an error like that, it means there was an attempt to assign to one of the frozen global prototypes.
